...
(use-package flymake-eslint
  ...
  :init
  ;; TODO: This isn't working. Eglot will take over flymake after this hook has been run and eslint won't work
  ;; I suspect same is happening with company mode as well?
  (add-hook 'typescript-mode-hook (lambda () (flymake-eslint-enable))))
(use-package eslint-fix
  :ensure t
  :general
  (nvmap :prefix "SPC"
	       "l f"   '(eslint-fix :which-key "ESLint fix")))
#+end_src
*** Rust
#+begin_src elisp
...
(use-package eglot
  :ensure t
  :hook
  ((csharp-mode nxml-mode typescript-mode) . eglot-ensure)
  ((csharp-mode nxml-mode typescript-mode) . (lambda () (add-hook 'before-save-hook 'eglot-format nil 'local)))
  :config
...
(use-package company
  ...
  (add-hook 'company-mode-hook (lambda ()
	  (substitute-key-definition 'company-complete-common
			              ...
			              company-active-map)))
  :hook
  ((csharp-mode nxml-mode rust-mode typescript-mode typescript-react-mode) . company-mode))
#+end_src
