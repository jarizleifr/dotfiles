...
(use-package eglot
  :ensure t
  :hook
  ((csharp-mode nxml-mode typescript-mode typescript-react-mode) . eglot-ensure)
  ((csharp-mode nxml-mode typescript-mode typescript-react-mode) . (lambda () (add-hook 'before-save-hook 'eglot-format nil 'local)))
  :config
